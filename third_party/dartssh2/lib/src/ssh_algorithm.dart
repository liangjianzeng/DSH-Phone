...
class SSHAlgorithms {
  ...
  /// Compression algorithms (SSH uses zlib; 'none' disables). The app
  /// enables zlib by default so long JSON/context payloads transfer smaller
  /// and faster over the tunnel.
  final List<String> compression;
