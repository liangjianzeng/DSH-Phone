...
- **当前版本**：v0.1.5（build 11）
- **安装包**：最新构建产物见 `build/app/outputs/flutter-apk/app-release.apk`；历史版本 [`apk/DSH-Phone-v0.1.3.apk`](apk/DSH-Phone-v0.1.3.apk)、[`apk/DSH-Phone-v0.1.2.apk`](apk/DSH-Phone-v0.1.2.apk)、[`apk/DSH-Phone-v0.1.1.apk`](apk/DSH-Phone-v0.1.1.apk)
